 ...
 * 
 * FORMA 3 -deixando mais simples( chamando a função com arrow function) [INDEIRETAFILHO]
 * 
 * FORMA 4 - PODEMOS ATE COLOCAR UMA CONSTANTE PARA RECEBER O PROPS.QYUANDOCLICAR PARA DEIXAR MENOR AINDA..[INDIRETA FILHO]
 * 
 * FORMA 5 - COMO NÃO ESTAMOS USANDO O [E] DA FUNÇÃO PODEMOS COLOCAR O UNDERLINE PARA DIZER QUE NÃO NOS INTERESSA RECEBER O EVENTO DO CLICK[INDIRETAFILHO]
 * 
